...
class Font2Font(object):
    ...
    def train(self, lr=0.002, epoch=100, schedule=10, resume=True, freeze_encoder=False, sample_steps=10,
        ...
        d_optimizer = tf.train.AdamOptimizer(learning_rate, beta1=0.9).minimize(loss_handle.d_loss, var_list=d_vars)
        g_optimizer = tf.train.AdamOptimizer(learning_rate, beta1=0.9).minimize(loss_handle.g_loss, var_list=g_vars)
